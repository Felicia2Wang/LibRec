...
SYSTEM_PROMPT = (
    ...
    "Below is an example of a migration case:\n"
    "Case 670:\n"
    "Source Library: MySQLdb\n"
    "Masked Migration Purpose:Support Python 3 and use pure Python driver to improve cross-platform compatibility\n"
    "Intent Type:['Usability', 'Enhanced Features', 'Integration']\n"
    "Relevant Historical Cases:\n"
    "1. Source:  MySQLdb → Target: PyMySQL | Intent: ['For better compatibility']| Intent Type:['Usability']\n"
    "2. Source: simplejson → Target: json | Intent: ['reduce dependencies'] | Intent Type: ['Size/Complexity','Simplification']\n"
    "3. Source:  PIL → Target: Pillow | Intent: ['Get active maintenance and new features'] | Intent Type: ['Not Maintained/Outdated','Enhanced Features']\n"
    "\n"
    "Output:\n"
    "Case 670:\n"
    "1. PyMySQL\n"
